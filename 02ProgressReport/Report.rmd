...
```{r, echo=FALSE, out.width="50%", fig.cap="\\label{fig:HighLevelDesign}High Level Design"}
knitr::include_graphics("Images/HighLevelDesign.png")
```
...
```{r, echo=FALSE, out.height="40%", fig.cap="\\label{fig:MCUPinConnections}Sensor to MCU Connections"}
knitr::include_graphics("Images/MCUPinConnections.png")
```
...
```{r, echo=FALSE, out.height="25%", fig.cap="\\label{fig:MobileApplication}Mobile Application"}
knitr::include_graphics("Images/MobileApplication.png")
```
...
```{r, echo=FALSE, out.height="20%", fig.cap="\\label{fig:WebServerAndClient}Web Server and Client"}
knitr::include_graphics("Images/WebServerAndClient.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="\\label{fig:GSRFunctionality}GSR Functionality"}
knitr::include_graphics("Images/GSRFunctionality.png")
```
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/GSRVoltageDivider.png}
  \captionof{figure}{Voltage Follower}
  \label{fig:GSRVoltageDivider}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/VoltageFollower.png}
  \captionof{figure}{GSR Voltage Divider}
...
```{r, echo=FALSE, out.width="100%", fig.cap="\\label{fig:LPFAndAmp}LPF and Amplification"}
knitr::include_graphics("Images/LPFAmplification.png")
```
...
![](Images/HighStressTheoreticalVout.png){width=50%}
\hfill
![](Images/LowStressTheoreticalVout.png){width=50%}
\begin{figure}
\begin{subfigure}{0.5\textwidth}
\caption{\label{fig:HighStressTheoreticalVout}High Stress}
\end{subfigure}
\hfill
\begin{subfigure}{0.5\textwidth}
\caption{\label{fig:LowStressTheoreticalVout}Low Stress}
\end{subfigure}
\caption{Theoretical $V_{Out}$}
\end{figure}
...
```{r, echo=FALSE, out.width="60%", fig.cap="\\label{fig:PulseWaveform}Pulse Sensor Waveform"}
knitr::include_graphics("Images/Pulse.png")
```

```{r, echo=FALSE, out.width="60%", fig.cap="\\label{fig:PulseAndBPM}Pulse Waveform and BPM"}
knitr::include_graphics("Images/PulseAndBPM.png")
```
...
Figure \ref{fig:HumidityAndTemperature} illustrates the captured waveform of humidity and temperature in red and blue respectively. The sensor utilises I2C functionality.
...
```{r, echo=FALSE, out.width="50%", fig.cap="\\label{fig:SimplifiedIoT}Simplified IoT Based Medical Device (Adapted from \\cite{Webster2020})"}
knitr::include_graphics("Images/SimplifiedIotBasedMedicalDevice.png")
```
...
```{r, echo=FALSE, out.width="40%", fig.cap="\\label{fig:HypotheticalSkinConductanceResponse}Hypothetical Skin Conductance Response"}
knitr::include_graphics("Images/HypotheticalSkinConductanceResponse.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.cap="\\label{fig:OutputOfPPG}Output of PPG Photodetector"}
knitr::include_graphics("Images/OutputOfPPGPhotodetector.png")
```
...
```{r, echo=FALSE, out.width="70%", fig.cap="\\label{fig:TypicalPPG}Typical PPG Circuit (Adapted from: [@Webster2020])"}
knitr::include_graphics("Images/TypicalPPGCircuit.png")
```

[@Webster2020] illustrates a typical PPG circuit as seen in Figure \ref{fig:TypicalPPG}. Where T1 is a phototransistor.

PPG is an outstanding detector of cardiac arrhythmia [@Shelley2010] and is very sensitive, which allows it diagnose conditions which ECG cannot. Additionally, it is an accurate measure of heart rate variability (HRV).
...
\begin{minipage}{.4\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/CompleteProofOfConcept.jpg}
  \captionof{figure}{Proof of Concept Board}
  \label{fig:CompleteProofOfConcept}
\end{minipage}%
\hfill
\begin{minipage}{.4\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/WebPortalSensorReadings.png}
  \captionof{figure}{Sensor Readings Data Portal}
...
\begin{minipage}{.4\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/GSRSensorTop.jpg}
  \captionof{figure}{GSR Sensor Top}
  \label{fig:GSRSensorTop}
\end{minipage}%
\hfill
\begin{minipage}{.4\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/GSRSensorBottom.png}
  \captionof{figure}{GSR Sensor Bottom}
  \label{fig:GSRSensorBottom}
\end{minipage}
\hfill
\end{figure}
...
\begin{minipage}{.4\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/HexConversionResult.png}
  \captionof{figure}{HEX Conversion Result}
  \label{fig:HexConversionResult}
\end{minipage}%
\hfill
\begin{minipage}{.4\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Images/BleScanning.jpg}
  \captionof{figure}{BLE Scanning}
  \label{fig:BLEScanning}
\end{minipage}
\hfill
\end{figure}
...
```{r, echo=FALSE, out.width="60%", fig.cap="\\label{fig:RefSem1Timeline}Refined Semester 1 Timeline"}
knitr::include_graphics("Images/TimelineTwo.png")
```

```{r, echo=FALSE, out.width="90%", fig.cap="\\label{fig:Sem2Timeline}Semester 2 Timeline"}
knitr::include_graphics("Images/TimelineThree.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="\\label{fig:OriginalSem1Timeline}Original Semester 1 Timeline"}
knitr::include_graphics("Images/TimelineOne.png")
```
...
| Conclusion                                                       | Ahad               | 100%                                 |
| Editing                                                          | Alec, Ahad, Oliver | 20%, 20%, 60%                        |
