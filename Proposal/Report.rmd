...
Firstly we should start by defining what is and is not part of this project what we are doing is collecting biomarkers from the undertakers of this project in an unobtrusive and non-invasive manner, not requesting data from anyone outside of this project. It is important to note that this data will not be used for any diagnostic purposes. The health data itself will be stored offline and not shared over any networks.
